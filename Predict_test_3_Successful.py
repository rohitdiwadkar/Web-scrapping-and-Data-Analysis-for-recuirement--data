...
URL_TEMP = "http://www.indeed.com/jobs?q=siemens&l={}&start={}"

#loops through each city in the city list,
#and loops through each page with search results for that city
#100 results per page, 10 pages per city --> 1000 job postings per city
# each time this cell is run the results list resets aka is empty 
#(note this does not affect my dataframe)
...
MAX_RESULTS_PER_CITY = 200 #Set this to a high-value (5000) to 
